...
//um número indeterminado de informações (máximo de 50) contendo a matrícula funcional do empregado e o 
//número de meses de trabalho deste empregado. Mostre os três empregados mais recentes. Não existem dois 
//empregados admitidos no mesmo mês e a matrícula igual a zero ‘0’ encerra a leitura. 
